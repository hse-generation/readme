# Generated by Django 4.1.4 on 2022-12-13 11:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login', models.CharField(max_length=10, null=True, verbose_name='Логин')),
                ...
                ('github_link', models.CharField(max_length=200, null=True, verbose_name='Ccылка на github')),
                ('telegram', models.CharField(max_length=200, null=True, verbose_name='Ник в телеграм')),
                ('phone_number', models.CharField(max_length=15, null=True, verbose_name='Номер телефона')),
                ('specialization', models.CharField(max_length=200, null=True, verbose_name='Специализация')),
